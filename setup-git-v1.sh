...
# Author 	: 	Charles Breaud
# Website 	: 	http://www.charlesbreaud.com
##################################################################################################################
##################################################################################################################
#
...
git init
git config --global user.name "Charles Breaud"
git config --global user.email "cbreaud@charlesbreaud.com"
